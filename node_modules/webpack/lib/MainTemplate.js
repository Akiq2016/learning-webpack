...
module.exports = class MainTemplate extends Tapable {
	...
	constructor(outputOptions) {
		...
		this.hooks.render.tap(
			...
			(bootstrapSource, chunk, hash, moduleTemplate, dependencyTemplates) => {
				...
				console.log('让runtime代码和module代码进行拼接')
				...
				source.add("/******/ (");
				console.log('拼接 module 源码，mainTemplate 把渲染模块代码的职责委托给了 moduleTemplate，自身只负责生成 runtime 代码')
				source.add(
	...
	getRenderManifest(options) {
		...
		console.log('调用getRenderManifest：this.hooks.renderManifest。');
		console.log("在JavascritpModulePlugin中有监听这个事件进行mainTemplate的render函数触发");
	...
	renderBootstrap(hash, chunk, moduleTemplate, dependencyTemplates) {
		const buf = [];
		console.log("this.hooks.bootstrap.call 通过 bootstrap 这个钩子，用户可以添加自己的 runtime 代码")
		buf.push(
	...
	render(hash, chunk, moduleTemplate, dependencyTemplates) {
		console.log("this.renderBootstrap 生成 runtime 代码")
		...
		console.log("触发mainTemplate的render钩子 传入runtime代码")
		...
		if (chunk.hasEntryModule()) {
			console.log("todo: 触发 renderWithEntry 事件，让我们有机会修改生成后的代码")
